...
Matrices are extensions of vectors that havedimensions (number of rows and number of columns). Let's create a matrix  where the columns represent the characters of the movie and the rows are the songs. To do that we will use the commands:
