...
```{r}
train.tbl %>%
  slice_min(x_1, with_ties = FALSE)
# n = 10 (index)

train.tbl %>%
  slice_max(x_1, with_ties = FALSE)
# n = 104


mnist_27$index_train[10]
# 5096

mnist_27$index_train[104]
# 28633

plotImage(mnist$train$images[5096,])
mnist$train$labels[5096]

plotImage(mnist$train$images[28633,])
mnist$train$labels[28633]
...
calc_error <- function(kNear, train.tbl, test.tbl) {
  ...
  knn.model <- knn(y~x_1+x_2, data=train.tbl, k=kNear)
  pred <- predict(knn.model, test.tbl, type="class")
